import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, h, mergeProps, unref, createVNode, resolveDynamicComponent, computed, useSlots, ref, inject, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, Comment, cloneVNode, shallowRef, resolveComponent, getCurrentInstance, toRef, camelize, toValue, watch, hasInjectionContext, Fragment, onServerPrefetch, provide, useModel, createTextVNode, mergeModels, defineAsyncComponent, createElementBlock, isRef, useSSRContext, Suspense, createApp, renderList, useId, shallowReactive, onErrorCaptured, reactive, effectScope, nextTick, toRefs, useTemplateRef, withModifiers, normalizeProps, guardReactiveProps, watchEffect, normalizeStyle, getCurrentScope, Teleport, markRaw, toHandlerKey, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { m as serialize, n as klona, o as defu, q as parseQuery, r as defuFn, v as hasProtocol, l as joinURL, w as parseURL, f as encodePath, x as decodePath, y as isEqual, z as withQuery, A as isScriptProtocol, B as getContext, C as withTrailingSlash, D as withoutTrailingSlash, E as sanitizeStatusCode, $ as $fetch$1, F as baseURL, j as createError$1, G as executeAsync } from '../_/nitro.mjs';
...
import { reactivePick, reactiveOmit, onKeyStroke, unrefElement, useVModel, useMounted, createSharedComposable, useRafFn, defaultWindow } from '@vueuse/core';
...
const _routes = [
  {
    name: "certificates",
    path: "/certificates",
    component: () => import('./certificates-14Yv1Gbp.mjs')
  },
  {
    name: "works",
    path: "/works",
    component: () => import('./works-BxkwKaHk.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BelYP0nu.mjs')
  }
];
...
const title = "Ислам Гаев - стоматолог-хирург и имплантолог";
const description = "Персональный сайт стоматолога-хирурга и имплантолога Ислама Гаева: имплантация, сложные удаления, All-on-4 и естественное восстановление улыбки.";
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useSeoMeta({
      ...
      ogImage: "https://images.unsplash.com/photo-1606811841689-23dfddce3e95?q=80&w=1400&auto=format&fit=crop",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-O59B9_m1.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DNON1jQk.mjs'));
...
export { Primitive as P, __nuxt_component_0$1 as _, _sfc_main$d as a, useAppConfig as b, useComponentUI as c, _sfc_main$8 as d, entry_default as default, tv as t, useHead as u };
