...
const _routes = [
  {
    name: "certificates",
    path: "/certificates",
    component: () => import('./certificates-BGGf2WlC.mjs')
  },
  {
    name: "works",
    path: "/works",
    component: () => import('./works-CRxK4cs9.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CtnhBqfJ.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404--kcdCXDd.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DnM7Mr6g.mjs'));
