import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, defineAsyncComponent, computed, provide, Fragment, defineComponent, toRefs, renderSlot, toHandlerKey, camelize, watch, nextTick, h, Comment, mergeProps, cloneVNode, openBlock, createBlock, unref, withCtx, Teleport, createCommentVNode, watchEffect, markRaw, createTextVNode, toDisplayString, createElementBlock, createVNode, withModifiers, normalizeProps, guardReactiveProps, normalizeStyle, onServerPrefetch, toValue, resolveDynamicComponent, useSSRContext, useModel, mergeModels, resolveComponent, useSlots, renderList, useTemplateRef, useId, Suspense, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import defu$1, { defu, defuFn } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/ufo/dist/index.mjs";
import { useHead as useHead$1, headSymbol, useSeoMeta as useSeoMeta$1 } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/@unhead/vue/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon } from "@iconify/vue";
import { klona } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/klona/dist/index.mjs";
...
import { debounce } from "C:/Users/babugoev.ka/Desktop/Kantemir/sait_sveti/saitfotcveta/node_modules/perfect-debounce/dist/index.mjs";
...
const _routes = [
  {
    name: "certificates",
    path: "/certificates",
    component: () => import("./_nuxt/certificates-BGGf2WlC.js")
  },
  {
    name: "works",
    path: "/works",
    component: () => import("./_nuxt/works-CRxK4cs9.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CtnhBqfJ.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404--kcdCXDd.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DnM7Mr6g.js"));
